            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full sm:p-6 animate-fade-in-up">
                <div>
                     ...
                     <p className="text-sm text-gray-500 text-center mt-1">
                         Mark <span className="font-mono font-medium">{record.transactionId}</span> as paid.
                     </p>
                     ...
                     <form onSubmit={handleSubmit} className="mt-5 space-y-4">
                         ...
                         <div className="flex gap-3 mt-6">
                            ...
                            <button type="submit" disabled={isSubmitting} className="flex-1 bg-green-600 text-white font-bold py-2.5 rounded-lg hover:bg-green-700 transition-colors shadow-md disabled:opacity-50">
